...
mosaic: build
	...
	python3 scripts/mosaic_mark.py --paper a4paper $(if $(GRID),--grid $(GRID),) --badge --out thesis_mosaic_marked.pdf || { echo 'Hint: pip install reportlab'; exit 1; }
	@echo "--- Mosaic ready: thesis_mosaic_marked.pdf ---"
clean:
